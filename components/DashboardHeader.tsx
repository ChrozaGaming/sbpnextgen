        ...
        <div className="flex justify-between h-16">
          ...
          <div className="flex">
            <div className="flex-shrink-0 flex items-center">
              <Link href="/dashboard" className="text-2xl font-bold text-blue-600">Dashboard</Link>
            </div>
          ...
          <div className="hidden md:ml-6 md:flex md:items-center">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                ...
                <p className="text-xs font-medium text-gray-500 group-hover:text-gray-700 capitalize">{role}</p>
              </div>
            </div>
