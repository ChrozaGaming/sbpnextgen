          ...
          <div className="ml-8 space-y-4">
            <div className="flex items-start space-x-3 bg-white p-4 rounded-lg shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="text-gray-700">
                <span className="font-semibold">Buat Rekap PO Baru:</span>{" "}
                Tombol untuk membuat entri Purchase Order baru. Klik tombol ini
                di pojok kanan atas untuk menambahkan data PO baru.
              </div>
            </div>
            <div className="flex items-start space-x-3 bg-white p-4 rounded-lg shadow-sm hover:shadow-md transition-shadow">
              <span className="text-blue-500 text-xl">•</span>
              <div className="text-gray-700">
                <span className="font-semibold">Cetak Rekap:</span> Fitur untuk
                mencetak atau mengekspor laporan rekap Purchase Order ke format
                PDF.
              </div>
            </div>
          </div>
        ...
        <section className="transform transition-all duration-300 hover:translate-x-2">
          ...
          <div className="ml-8 space-y-4">
            ...
            <div className="flex items-start space-x-3 bg-white p-4 rounded-lg shadow-sm hover:shadow-md transition-shadow">
              <span className="text-blue-500 text-xl">•</span>
              <div className="text-gray-700">
                <span className="font-semibold">Filter Periode:</span> Gunakan
                filter tahun dan bulan untuk melihat data berdasarkan periode
                tertentu.
              </div>
            </div>
          </div>
        ...
        <section className="transform transition-all duration-300 hover:translate-x-2">
          ...
          <div className="ml-8 space-y-4">
            ...
            <div className="flex items-start space-x-3 bg-white p-4 rounded-lg shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="text-gray-700">
                <div className="font-semibold mb-2">
                  Status Profit ditampilkan dengan indikator warna:
                </div>
        ...
        <section className="transform transition-all duration-300 hover:translate-x-2">
          ...
          <div className="ml-8 space-y-4">
            <div className="flex items-start space-x-3 bg-white p-4 rounded-lg shadow-sm hover:shadow-md transition-shadow">
              <span className="text-blue-500 text-xl">•</span>
              <div className="text-gray-700">
                <span className="font-semibold">Edit Biaya:</span> Klik tombol
                &quot;Edit Biaya&quot; untuk mengubah biaya pelaksanaan PO.
                Sistem akan otomatis menghitung ulang profit dan status.
              </div>
            </div>
            <div className="flex items-start space-x-3 bg-white p-4 rounded-lg shadow-sm hover:shadow-md transition-shadow">
              <span className="text-blue-500 text-xl">•</span>
              <div className="text-gray-700">
                <span className="font-semibold">Preview Perubahan:</span> Saat
                melakukan edit, sistem akan menampilkan preview perhitungan
                profit dan status secara real-time sebelum perubahan disimpan.
              </div>
            </div>
          </div>
        </section>
